...
namespace UDSStudio
{
    public class StudioConfig:INotifyPropertyChanged
    {
        ...
        private MasterInfo masterVar;
        public MasterInfo MasterVar
        {
        ...
        public bool IsConnect
        {
            ...
            {
                isConnect = value;
                OnPropertyChanged(new PropertyChangedEventArgs("IsConnect"));
            }
        }
        ...
        private PackInfo packVar;
        public PackInfo PackVar
        {
            get { return packVar; }
            set
            {
