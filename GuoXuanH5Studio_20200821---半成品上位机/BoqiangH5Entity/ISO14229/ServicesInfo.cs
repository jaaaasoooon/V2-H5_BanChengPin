...
namespace BoqiangH5.ISO14229
{
    ...
    {
        #region DID
        public const int MasterTelemDID = 0x1000;             // 主控遥测数据块, 主控遥测DID起止(1000, 11FF)
        public const int MasterParaDID = 0x1400;              // 主控参数值数据块， 主控参数DID起止(1400, 15FF)
        public const int MasterAdjustDID = 0x1600;            // 主控校准值数据块， 主控校准DID起止(1600, 17FF)
        public const int MasterCtrlDID = 0x1800;              // 主控控制DID起止(1800, 18FF)
        ...
        public const int BMSSysTimeDID = 0x1802;              // BMS系统时间

        public const int MasterTeleBytesCount = 55;           // 1000	主控遥测数据块	55
        public const int MasterParaBytesCount = 354;          // 1400  主控参数值数据块 总字节数 354
        public const int MasterAdjustBytesCount = 34;         // 1600	主控校准值数据块 总字节数	34
